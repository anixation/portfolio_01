...
$mail_to = "kumar.anish28@gmail.com";//Your email address
$mail_from=$_POST["txtEmail"];
$mail_sub="Message from saas.com";
$mail_mesg=$txtMsg;
...
echo ("<meta http-equiv='refresh' content='2;url=http://anishanandan.com/images/project/index.html/'>");// Your domain name.
?>